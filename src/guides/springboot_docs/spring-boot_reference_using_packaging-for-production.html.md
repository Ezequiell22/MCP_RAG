...
the application.
See the [Packaging Spring Boot Applications](../packaging/index.html) section of the documentation to read about these features.
...
See [Actuator](../../how-to/actuator.html) for details.