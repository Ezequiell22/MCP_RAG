...
Thereâs always a certain amount of overhead when running an uber jar without unpacking it, and in a containerized environment this can be noticeable.
...
Since you probably recompile your code more often than you upgrade the version of Spring Boot you use, itâs often better to separate things a bit more.
...
For Maven, see the [packaging layered jar or war section](../../../maven-plugin/packaging.html#packaging.layers) for more details on adding a layer index to the archive.
For Gradle, see the [packaging layered jar or war section](../../../gradle-plugin/packaging.html#packaging-executable.configuring.layered-archives) of the Gradle plugin documentation.