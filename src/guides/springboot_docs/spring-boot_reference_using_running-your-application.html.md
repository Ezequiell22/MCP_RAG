...
|  |  |
| --- | --- |
|  | The options below are best suited for running an application locally for development. For production deployment, see [Packaging Your Application for Production](packaging-for-production.html). |
...
Maven includes plugins for [Eclipse](https://maven.apache.org/plugins/maven-eclipse-plugin/) and [IntelliJ IDEA](https://maven.apache.org/plugins/maven-idea-plugin/).
...
See the [Hot Swapping](../../how-to/hotswapping.html) section in “How-to Guides” for details.